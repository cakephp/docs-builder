...
return [
    [
        ...
        'type' => 'internal',
        'priority' => 'normal',
        'url' => '/1/en/test.html#namespace-Foo\\Bar',
        'page_url' => '/1/en/test.html',
        'level' => 0,
        'max_level' => 2,
        'position' => 0,
        'max_position' => 3,
    ...
    [
        ...
        'type' => 'internal',
        'priority' => 'normal',
        'url' => '/1/en/test.html#level-1-subsection-1-title',
        'page_url' => '/1/en/test.html',
        'level' => 1,
        'max_level' => 2,
        'position' => 1,
    ...
    [
        ...
        'type' => 'internal',
        'priority' => 'normal',
        'url' => '/1/en/test.html#level-2-subsection-1-title',
        'page_url' => '/1/en/test.html',
        'level' => 2,
        'max_level' => 2,
        'position' => 2,
    ...
    [
        ...
        'type' => 'internal',
        'priority' => 'normal',
        'url' => '/1/en/test.html#level-1-subsection-2-title',
        'page_url' => '/1/en/test.html',
        'level' => 1,
        'max_level' => 2,
        'position' => 3,
