...
return [
    ...
    [
        ...
        'type' => 'internal',
        'priority' => 'normal',
        'url' => '/1/en/test/nested.html#nested',
        'page_url' => '/1/en/test/nested.html',
        'level' => 0,
        'max_level' => 1,
        'position' => 0,
        'max_position' => 1,
    ...
    [
        ...
        'type' => 'internal',
        'priority' => 'normal',
        'url' => '/1/en/test/nested.html#level-1-subsection-1-title',
        'page_url' => '/1/en/test/nested.html',
        'level' => 1,
        'max_level' => 1,
        'position' => 1,
    ...
    [
        ...
        'type' => 'internal',
        'priority' => 'normal',
        'url' => '/1/en/more.html#more',
        'page_url' => '/1/en/more.html',
        'level' => 0,
        'max_level' => 0,
        'position' => 0,
        'max_position' => 0,
    ...
    [
        ...
        'type' => 'internal',
        'priority' => 'low',
        'url' => '/1/en/appendices.html#appendices',
        'page_url' => '/1/en/appendices.html',
        'level' => 0,
        'max_level' => 0,
        'position' => 0,
        'max_position' => 0,
    ...
    [
        ...
        'type' => 'internal',
        'priority' => 'low',
        'url' => '/1/en/appendices/low-priority.html#low-priority',
        'page_url' => '/1/en/appendices/low-priority.html',
        'level' => 0,
        'max_level' => 0,
        'position' => 0,
        'max_position' => 0,
