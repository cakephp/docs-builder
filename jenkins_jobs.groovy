...
make populate-index SOURCE="$WORKSPACE" ES_HOST="$DOKKU_ELASTICSEARCH_AQUA_URL" SEARCH_URL_PREFIX="/authorization/1"
cd ..
...
cd docs-builder
# Build index for each version.
make populate-index SOURCE="$WORKSPACE" ES_HOST="$DOKKU_ELASTICSEARCH_AQUA_URL" SEARCH_URL_PREFIX="/authorization/2"
cd ..
...
cd docs-builder
# Build index for each version.
make populate-index SOURCE="$WORKSPACE" ES_HOST="$DOKKU_ELASTICSEARCH_AQUA_URL" SEARCH_URL_PREFIX="/authentication/1"
cd ..
...
cd docs-builder
# Build index for each version.
make populate-index SOURCE="$WORKSPACE" ES_HOST="$DOKKU_ELASTICSEARCH_AQUA_URL" SEARCH_URL_PREFIX="/authentication/2"
cd ..
...
cd docs-builder
# Build index for each version.
make populate-index SOURCE="$WORKSPACE" ES_HOST="$DOKKU_ELASTICSEARCH_AQUA_URL" SEARCH_URL_PREFIX="/debugkit/3"
cd ..
...
cd docs-builder
# Build index for each version.
make populate-index SOURCE="$WORKSPACE" ES_HOST="$DOKKU_ELASTICSEARCH_AQUA_URL" SEARCH_URL_PREFIX="/debugkit/4"
cd ..
...
cd docs-builder
# Build index for each version.
make populate-index SOURCE="$WORKSPACE" ES_HOST="$DOKKU_ELASTICSEARCH_AQUA_URL" SEARCH_URL_PREFIX="/chronos/1"
cd ..
...
cd docs-builder
# Build index for each version.
make populate-index SOURCE="$WORKSPACE" ES_HOST="$DOKKU_ELASTICSEARCH_AQUA_URL" SEARCH_URL_PREFIX="/chronos/2"
cd ..
...
# Build index
make populate-index SOURCE="$WORKSPACE" ES_HOST="$DOKKU_ELASTICSEARCH_AQUA_URL" SEARCH_URL_PREFIX="/bake/1"
cd ..
...
# Build index
make populate-index SOURCE="$WORKSPACE" ES_HOST="$DOKKU_ELASTICSEARCH_AQUA_URL" SEARCH_URL_PREFIX="/bake/2"
cd ..
...
cd docs-builder
# Build index for each version.
make populate-index SOURCE="$WORKSPACE" ES_HOST="$DOKKU_ELASTICSEARCH_AQUA_URL" SEARCH_URL_PREFIX="/elasticsearch/2"
cd ..
...
cd docs-builder
# Build index for each version.
make populate-index SOURCE="$WORKSPACE" ES_HOST="$DOKKU_ELASTICSEARCH_AQUA_URL" SEARCH_URL_PREFIX="/migrations/2"
cd ..
...
cd docs-builder
# Build index for each version.
make populate-index SOURCE="$WORKSPACE" ES_HOST="$DOKKU_ELASTICSEARCH_AQUA_URL" SEARCH_URL_PREFIX="/migrations/3"
cd ..
...
cd docs-builder
# Build index for each version.
make populate-index SOURCE="$WORKSPACE" ES_HOST="$DOKKU_ELASTICSEARCH_AQUA_URL" SEARCH_URL_PREFIX="/phinx/0"
cd ..
